  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2 rounded-[18px] border border-(--input-border) bg-(--input-bg) px-3.5 pb-2 pt-3 backdrop-blur-[10px] transition-colors duration-200 focus-within:border-(--highlight)">
        <textarea
          ref={textareaRef}
          className="max-h-36 min-h-18 w-full resize-none overflow-y-auto border-none bg-transparent text-[0.9375rem] leading-6 text-(--text-base) outline-none placeholder:text-(--text-footer) [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-(--surface-border) [&::-webkit-scrollbar-track]:bg-transparent"
          placeholder="Reply..."
          value={value}
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2.5">
            <div ref={dropdownWrapRef} className="relative">
              ...
              >
                Minimax-M2.7{thinkingEnabled ? "\u2002思考" : ""}
                <svg
                  width="10"
                  height="10"
                  viewBox="0 0 24 24"
